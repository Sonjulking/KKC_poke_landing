  ...
  return (
    <div className="flex flex-col h-full font-bold">
      <div className="flex items-center justify-between border-b-2 border-black pb-2 mb-2">
        <span className="text-xl">고강찬 (Ko KangChan)</span>
        {/*         <span className="text-sm">Lv.999</span>*/}
      </div>
      <div className="flex flex-1">
        {/* Left: Avatar */}
        <div className="w-1/3 border-2 border-gray-400 bg-gray-200 relative overflow-hidden mr-4">
          <Image
        ...
        <div className="w-2/3 flex flex-col h-full overflow-hidden">
          <div className="flex-1 overflow-y-auto space-y-4 pr-1">
            ...
            <div className="border-t-2 border-gray-300 pt-1">
              <div className="text-xs mb-1 text-gray-500">기술스택</div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">2024.06 ~ 2024.10</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Education (Academy) */}
            <div className="border-t-2 border-gray-300 pt-1">
              <div className="text-xs mb-1 text-red-600">학력</div>
              <div className="text-sm">
                <div className="font-bold">신한대학교</div>
                <div className="text-xs text-gray-500">컴퓨터공학 (2016-2023)</div>
              </div>
            </div>

            {/* Certifications (Ribbons) */}
            <div className="border-t-2 border-gray-300 pt-1">
              <div className="text-xs mb-1 text-purple-600">자격증</div>
              <div className="flex flex-wrap gap-2 text-xs">
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded border border-purple-300">정보처리기사</span>
                <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded border border-blue-300">SQLD</span>
              </div>
            </div>
          </div>
        </div>
